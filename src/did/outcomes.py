...
OUTCOME_REGISTRY: Tuple[OutcomeSpec, ...] = (
    ...
    OutcomeSpec("pole_rate", "pole_rate_100w_mean", "lexical", ddd_allowed=False),
    ...
    *_extended_semantic_axis_specs(),
    ...
    OutcomeSpec(
        "sem_axis_ideology_extreme_left_global",
        "sem_axis_ideology_share_left_below_p10_global",
        "semantic_axis",
        ddd_allowed=False,
    ),
    OutcomeSpec(
        "sem_axis_ideology_extreme_right_global",
...
OUTCOME_LABELS_SHORT: dict[str, str] = {
    ...
    "pole_rate": "Pole-word rate (L+R per 100w)",
    "left_rate": "Left rate",
    ...
    "sem_axis_ideology_pole_share": "Sem. pole share (absolute cutoffs; IT-scale)",
    "sem_axis_ideology_pole_share_pct": "Sem. pole share (p10/p90 pct)",
    "sem_axis_ideology_pole_share_global": "Sem. pole share (global pct)",
    "sem_axis_ideology_pole_share_p05p95": "Sem. pole share (p5/p95)",
    "sem_axis_ideology_pole_share_p15p85": "Sem. pole share (p15/p85)",
