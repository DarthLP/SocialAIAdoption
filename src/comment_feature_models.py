...
explicit CPU, Apple MPS, or CUDA device routing. Used by `scripts/features/compute_comment_features.py`
and inlined in `notebooks/colab_compute_comment_features_gpu.ipynb` (regenerated by
`scripts/devtools/_gen_colab_standalone_nb.py`) for standalone Colab GPU runs.
