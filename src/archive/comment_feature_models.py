...
explicit CPU, Apple MPS, or CUDA device routing. Used by `scripts/archive/features/compute_comment_features.py`
and inlined in `scripts/archive/notebooks/colab_compute_comment_features_gpu.ipynb` (regenerated by
`scripts/archive/devtools/_gen_colab_standalone_nb.py`) for standalone Colab GPU runs.
