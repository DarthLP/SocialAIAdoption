...
Functionality:
- Thin wrapper around `_enriched_shard_runner.py` (--pass polarization).
- See `compute_enriched_shard_features.py --pass all` for combined runs.
...
if __name__ == "__main__":
    _load_runner().main_with_pass(
        fixed_pass="polarization",
        prog="compute_polarization_features",
