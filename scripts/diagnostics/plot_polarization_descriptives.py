...
DUAL_UNIVERSE_METRIC_PLOTS = [
    ...
    ("style_index_full_mean", "style_index_full"),
    ("style_index_reduced_mean", "style_index_reduced"),
    ("log_len_mean", "log_len_mean"),
    ("share_ge20w", "share_ge20w"),
    ("ttr_50w_mean", "ttr_50w"),
    ("readability_mean", "readability"),
...
def write_all_descriptive_figures(
    ...
    if not country_df.empty:
        for metric, fname in [
            ...
            ("style_index_full_mean", "style_index_full.png"),
            ("style_index_reduced_mean", "style_index_reduced.png"),
